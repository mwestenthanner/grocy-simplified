<template>
    <div class="list-item">
        ...
        <div class="controls">
            <button @mouseenter="showTooltip('Mark as used up')" @mouseleave="tooltip = false">
            ...
            <button @mouseenter="showTooltip('Add to shopping list')" @mouseleave="tooltip = false">
            ...
            <button @mouseenter="showTooltip('Change expiry date')" @mouseleave="tooltip = false">
            ...
            <button @mouseenter="showTooltip('Move item')" @mouseleave="tooltip = false">
